...
const getPath = (name, props) => {
  switch (name) {
    ...
    case 'options':
      return (
        <React.Fragment>
          <path {...props} d="M14.827 2.851c0 1.561-1.266 2.827-2.827 2.827s-2.827-1.266-2.827-2.827c0-1.561 1.266-2.827 2.827-2.827s2.827 1.266 2.827 2.827z" />
          <path {...props} d="M14.827 12c0 1.561-1.266 2.827-2.827 2.827s-2.827-1.266-2.827-2.827c0-1.561 1.266-2.827 2.827-2.827s2.827 1.266 2.827 2.827z" />
          <path {...props} d="M14.827 21.149c0 1.561-1.266 2.827-2.827 2.827s-2.827-1.266-2.827-2.827c0-1.561 1.266-2.827 2.827-2.827s2.827 1.266 2.827 2.827z" />
        </React.Fragment>
      )
    case 'check':
      return (
